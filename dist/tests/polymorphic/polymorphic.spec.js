...
var handle;
describe("Polymorphic Config Tests", function () {
    ...
    it("Should backpopulate a polymorphic relationship [single add, single remove]", function () { return __awaiter(void 0, void 0, void 0, function () {
        var foo, bar;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, payload_1.default.update({
                            ...
                            id: foo.id,
                            data: {
                                bars_or_bazzes: [{ relationTo: payload_config_1.barSlug, value: bar.id }],
                            },
                        })];
                case 3:
...
//# sourceMappingURL=polymorphic.spec.js.map